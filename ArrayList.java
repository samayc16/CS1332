...
public class ArrayList<T> {
    ...
    public void addAtIndex(int index, T data) {
        ...
        if (size >= backingArray.length) {
            temp = (T[]) new Object[backingArray.length * 2];
        }
        for (int count = 0; count < (size + 1); count++) {
            ...
            if (count < index) {
                temp[count] = backingArray[count];
            }
            if (count == index) {
                temp[count] = data;
            }
            if (count > index) {
                temp[count] = backingArray[count - 1];
            }
        }
        size++;
        backingArray = temp;
    ...
    public T removeAtIndex(int index) {
        ...
        for (int count = 0; count < (size + 1); count++) {
            ...
            if (count == index) {
                dtr = backingArray[count];
            }
            if (count > index) {
                temp[count - 1] = backingArray[count];
            }
        }
        size--;
        backingArray = temp;
